...
//             top: 10,
//           }}
//           // okButtonProps={{form:'updateCampaignForm', key: 'submit', htmlType: 'submit'}}
//           title="Update Campaign"
//           visible={openModal}
//           onCancel={this.handleCancel}
//           footer={[
...
//                 <InputNumber
//                   ref={this.quantityRef}
//                   disabled={record?.isshare ? true : false}
//                   addonAfter=" products"
//                   min={this.state.switchState ? "1" : "10"}
//                   max={availableQuantity}
//                   style={{ width: "60vh" }}
...
//               >
//                 <Space style={{ width: "60vh" }} size={20}>
//                   <Switch onClick={this.toggleSwitch} style={{ marginRight: "20" }} />
